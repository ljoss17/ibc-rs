    ...
    // do this without a major redesign.
    {
        ...
        let client_state = {
            ...
            let raw_client_state = RawTmClientState {
                ...
                trusting_period: Some(Duration::from_secs(64000).try_into().unwrap_or_default()),
                unbonding_period: Some(Duration::from_secs(128_000).try_into().unwrap_or_default()),
                max_clock_drift: Some(Duration::from_millis(3000).try_into().unwrap_or_default()),
                latest_height: Some(
                    Height::new(
