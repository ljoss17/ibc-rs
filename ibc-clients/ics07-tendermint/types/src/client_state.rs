...
impl From<ClientState> for RawTmClientState {
    fn from(value: ClientState) -> Self {
        ...
        Self {
            ...
            trusting_period: Some(value.trusting_period.try_into().unwrap_or_default()),
            unbonding_period: Some(value.unbonding_period.try_into().unwrap_or_default()),
            max_clock_drift: Some(value.max_clock_drift.try_into().unwrap_or_default()),
